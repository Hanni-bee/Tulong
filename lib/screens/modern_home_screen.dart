...
class _ModernHomeScreenState extends State<ModernHomeScreen>
  ...
  Future<bool> _showEmergencyConfirmationModal(BuildContext context) async {
    ...
    String emergencyMessage = authProvider.emergencyMessage ?? 
        'ðŸš¨ EMERGENCY: I need immediate assistance!';
    
    // Ensure message is not empty
    if (emergencyMessage.trim().isEmpty) {
      emergencyMessage = 'ðŸš¨ EMERGENCY: I need immediate assistance!';
    }
          ...
          return AlertDialog(
            ...
            content: Column(
              ...
              children: [
                Text(
                  isReady
                      ? 'Youâ€™re connected. You can send emergency messages now.'
                  ...
                  children: [
                    ...
                    Column(
                      ...
                      children: [
                        ...
                        Text(
                          'Broadcasting to nearby devicesâ€¦',
