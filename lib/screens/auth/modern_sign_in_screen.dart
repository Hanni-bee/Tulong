...
class _ModernSignInScreenState extends State<ModernSignInScreen>
  ...
  void _attemptFirebaseSync(String username, String password) async {
    try {
      ...
      final firebaseUser = await firebaseService.signInWithUsername(
      ...
      // Silent fail on sync - user is already logged in offline
    }
  }
    ...
    return Column(
      ...
      children: [
        ...
        _buildPrimaryButton()
          ...
          .shimmer(delay: 2.seconds, duration: 1500.ms, color: Colors.white.withOpacity(0.2))
          .animate()
    ...
    return SafeArea(
      child: Column(
        ...
        children: [
          ...
          ).animate().shimmer(duration: 3.seconds, color: Colors.white.withOpacity(0.3)),
    ...
    return Stack(
      children: [
        ...
        Positioned(
          top: -100,
          right: -50,
          child: _Orb(color: Colors.white.withOpacity(0.12), size: 400),
        ).animate(onPlay: (c) => c.repeat(reverse: true))
        ...
        Positioned(
          bottom: 50,
          left: -100,
          child: _Orb(color: Colors.white.withOpacity(0.08), size: 350),
        ).animate(onPlay: (c) => c.repeat(reverse: true))
        ...
        Positioned(
          top: 200,
          left: 50,
          child: _Orb(color: Colors.white.withOpacity(0.05), size: 150),
        ).animate(onPlay: (c) => c.repeat(reverse: true))
