/*
 * ESP32 nRF24L01 + Bluetooth SPP Voice Bridge (Node A) - WITH SOS SUPPORT - UPDATED
 * 
...
#define CE_PIN         26
#define CSN_PIN        27
#define BT_DEVICE_NAME "ESP32_NodeA_Voice"
...
void setup() {
  ...
  logEvent("BOOT", "=== ESP32 Voice Bridge (Node A: nRF24 + SPP) WITH SOS ===");
  ...
  radio.openWritingPipe(address[0]);    // send to Node B
  radio.openReadingPipe(1, address[1]); // receive on Node A's address
  radio.startListening();
